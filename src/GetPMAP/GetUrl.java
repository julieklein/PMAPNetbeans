...
//                    int intP1prime = Integer.parseInt(P1prime);
    ...
    private void getEnzymeNameSymbolId(Matcher patternEnzymeName, ProteaseDBEntryPMAP pdb, String enzymeTaxon) throws IOException {
        if (patternEnzymeName.find()) {
            ...
            if (enzymeTaxon.equalsIgnoreCase("Homo Sapiens")) {
                ...
                if (enzymeTaxon.equalsIgnoreCase("Rattus Norvegicus")) {
    ...
    private void getProteinNameSymbolId(Matcher patternProteinName, SubstrateDBEntryPMAP sdb, String pmapentry, CleavageSiteDBEntryPMAP csdb) throws IOException {
        if (patternProteinName.find()) {
            ...
            csdb.setCserrormsg("Check Substrate Symbol and Accession; add to Substrate Librairy");
            System.out.println("Check Substrate Symbol and Accession; add to Substrate Librairy");
            BufferedReader bReader = createBufferedreader("//Users/julieklein/Desktop/ProteasiX/PMAPSubstrateHSALibrairy.txt");
            String line;
            while ((line = bReader.readLine()) != null) {
                String splitarray[] = line.split("\t");
            ...
            String proteinname = "n.d.";
            String proteinsymbol = "n.d.";
            String proteinaccession = "n.d";
            sdb.setSubstrateprotname(proteinname);
            sdb.setSubstratename(proteinsymbol);
            sdb.setSubstrateacessionlist(proteinaccession);
            System.out.println(proteinname);
...
//
//       
        String htmlcontent = getHtmlcontent(new URL("file:///Users/julieklein/Desktop/ProteasiX/PMAP/MARS2012/search_result_9.html")).toString();
        ...
        while (retrievepmapentryid.find()) {
            ...
            if (!(enzymeTaxon.equalsIgnoreCase("Homo Sapiens")) && !(enzymeTaxon.equalsIgnoreCase("Rattus Norvegicus")) && !(enzymeTaxon.equalsIgnoreCase("Mus Musculus"))) {
                ...
                Matcher patternEnzymeName = getPatternmatcher("<div\\s+id=\"protdata\">[^<]+<table>[^<]+<tr>[^<]+<th\\s+class=\"th3\">Definition:</th>[^<]+<td><b>"
                        + "([^<]+)", pmapentry);
                getEnzymeNameSymbolId(patternEnzymeName, pdb, enzymeTaxon);
                ...
                getProteinNameSymbolId(patternProteinName, sdb, pmapentry, csdb);
        ...
        System.out.println("-----------------");
        try {
            csvWriter = new PrintStream("PMAPCSDBp9.csv");
